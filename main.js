...
function createWindow () { //aqui procedemos a crear la ventana
  win = new BrowserWindow({width: 1200, height: 720}) //definimos un alto y ancho en el que s einicializará nuestra aplicación

  // le pasamos como ruta el archivo index que se genera luego de ocmpilar nuestra aplicación de Angular
  win.loadURL(`file://${__dirname}/dist/febokac/index.html`)
